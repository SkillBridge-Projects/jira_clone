...
import { User, Project, Issue, IUser, IProject } from 'mongooseEntities';
...
const seedIssues = (project: IProject) => {
  const { users } = project;
...
// const seedComments = (issues: IIssue[], users: mongoose.Types.ObjectId[]) => {
//   const comments = [
//     new Comment({
...
//     new Comment({
//       body: 'O snail\nClimb Mount Fuji,\nBut slowly, slowly!',
//       issueId: issues[6]._id,
//       userId: users[2],
//     }).save(),
//     new Comment({
//       body: 'Everything I touch\nwith tenderness, alas,\npricks like a bramble.',
//       issueId: issues[7]._id,
//       userId: users[2],
//     }).save(),
//   ];
